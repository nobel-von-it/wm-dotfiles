...
static const char col_cyan[] = "#6b71a8";
/*static const char col_cyan_old[] = "#005577";*/
...
static const char *termcmd[] = {
    ...
    "sh",
    "-c",
    "tmux has-session -t 1 2>/dev/null && tmux attach-session -t 1 || tmux",
    NULL};
...
static const Key keys[] = {
    ...
    {MODKEY | ShiftMask, XK_y, spawn,
     SHCMD("firefox https://www.youtube.com/")},
    {MODKEY | ShiftMask, XK_g, spawn,
     SHCMD("firefox https://mail.google.com/mail/u/0/#inbox")},
    /*{MODKEY | ShiftMask, XK_d, spawn, SHCMD("discord")},*/
    /*{MODKEY | ShiftMask, XK_s, spawn, SHCMD("steam")},*/
    {MODKEY, XK_z, spawn, SHCMD("xcolor | xclip -selection clipboard")},
    {MODKEY | ShiftMask, XK_o, spawn, SHCMD("obsidian")},
    {MODKEY, XK_e, spawn, SHCMD("nautilus")},
    {MODKEY | ShiftMask, XK_p, spawn, SHCMD("portproton")},
