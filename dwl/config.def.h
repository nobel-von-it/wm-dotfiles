...
static const MonitorRule monrules[] = {
    ...
    */
    /* defaults */
    {"HDMI-A-1", 0.55f, 1, 1, &layouts[0], WL_OUTPUT_TRANSFORM_NORMAL, 1080,
     200},
    {"DP-1", 0.55f, 1, 1, &layouts[0], WL_OUTPUT_TRANSFORM_FLIPPED, 0, 0},
};
...
/* commands */
static const char *termcmd[] = {"alacritty",      "-e", "sh", "-c",
                                "tmux a || tmux", NULL};
